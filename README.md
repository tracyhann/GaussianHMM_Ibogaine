...
`parcel.py`
- Concatnated the sub-54095s001_ses-V2 resting state data (2 x 5 minutes fMRI scans at resting state). Each scan has 369 T, and is registered to the MNI152 space.
